...
.short-chain-node { background: linear-gradient(145deg, var(--node-bg-from) 0%, var(--node-bg-to) 100%); border-radius: 8px; padding: 8px 12px; border: 2px solid rgba(16,185,129,var(--node-border-opacity)); transition: all .3s cubic-bezier(.4,0,.2,1); min-width:140px; max-width:170px; cursor:pointer; position:relative; }
...
.short-chain-node.status-completed { border-color: rgba(34,197,94,.85); background: linear-gradient(145deg, var(--node-completed-bg-from) 0%, var(--node-completed-bg-to) 100%); box-shadow:0 0 18px rgba(34,197,94,.4); }
...
.node-title { font-size:12px; font-weight:600; color:var(--app-text-primary); line-height:1.3; flex:1; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
.node-stats { display:flex; align-items:center; gap:8px; margin-top:6px; padding-top:6px; border-top:1px solid rgba(16,185,129,.3); }
.node-stats .stat-item { display:flex; align-items:center; gap:4px; font-size:11px; color:var(--app-text-secondary); }
...
.node-detail-popup.fixed-popup { position:fixed; transform:translateX(-50%); background: linear-gradient(145deg, var(--popup-bg-from) 0%, var(--popup-bg-to) 100%); border:2px solid var(--popup-border); border-radius:12px; padding:16px; min-width:300px; max-width:380px; box-shadow:0 10px 40px var(--app-shadow),0 0 0 1px rgba(255,255,255,.08),0 0 20px rgba(16,185,129,.35); z-index:10000; backdrop-filter:blur(20px); pointer-events:auto; transition: all 0.3s ease; }
...
.node-detail-popup.fixed-popup.placement-below::after { top:-10px; border-bottom:10px solid var(--popup-arrow-border); }
.node-detail-popup.fixed-popup:not(.placement-below)::after { bottom:-10px; border-top:10px solid var(--popup-arrow-border); }
...
.node-detail-popup.fixed-popup.placement-below::before { top:-8px; border-bottom:8px solid var(--popup-arrow-bg); }
.node-detail-popup.fixed-popup:not(.placement-below)::before { bottom:-8px; border-top:8px solid var(--popup-arrow-bg); }
...
.popup-title { font-size:14px; font-weight:700; color:var(--popup-title-color); letter-spacing:.3px; transition: color 0.3s ease; }
.close-icon { cursor:pointer; color:var(--app-text-secondary); font-size:16px; padding:2px; border-radius:4px; transition:all .3s ease; }
.close-icon:hover { color:var(--app-text-primary); background:rgba(148,163,184,.1); transform:rotate(90deg); }
...
.stat-label { font-size:11px; color:var(--app-text-secondary); font-weight:500; transition: color 0.3s ease; }
.stat-value { font-size:14px; color:var(--popup-title-color); font-weight:700; transition: color 0.3s ease; }
.popup-details { display:flex; flex-direction:column; gap:8px; }
.detail-line { display:flex; align-items:flex-start; gap:8px; font-size:12px; color:var(--popup-text-color); line-height:1.5; padding:8px; background:linear-gradient(135deg, rgba(16,185,129,.08) 0%, rgba(34,197,94,.08) 100%); border-radius:6px; border-left:3px solid rgba(16,185,129,.5); transition: color 0.3s ease; }
